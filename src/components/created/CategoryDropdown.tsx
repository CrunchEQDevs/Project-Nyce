...
// Define interface para a categoria
interface Category {
  id: string | number;
  name: string;
}

// Define interface para as props do componente
interface CategoryDropdownProps {
  categories: Category[];
  onSelect: (categoryId: string | number) => void;
}

export default function CategoryDropdown({ categories, onSelect }: CategoryDropdownProps) {
