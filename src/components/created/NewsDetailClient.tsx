...
import { getNewsBySlug, getRelatedNews, getAllNews } from '@/lib/newsData';

// Definindo a interface para os itens de notícia
interface NewsItem {
  id: number;
  date: string;
  title: string;
...
export default function NewsDetailClient({ newsSlug }: { newsSlug: string }) {
    ...
    useEffect(() => {
      // O resto permanece igual, mas agora usando a prop newsSlug
